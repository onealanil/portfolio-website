      ...
      <div className="h-[100vh] bg-gradient-to-r from-pink-200 via-cyan-100 to-cyan-200 dark:bg-none dark:bg-slate-900">
        ...
        <div className="w-full flex space-x-3 justify-center mt-2">
          <FaFacebook
            ...
            onClick={() => {
              window.location.href = "https://www.facebook.com/aneeel.7642/";
              return null;
            }}
          />
          <FaInstagramSquare
            ...
            className="cursor-pointer"
            onClick={() => {
              window.location.href = "https://www.instagram.com/anil_oneal12/";
              return null;
            }}
          />
          <FaGithubSquare
          ...
          >
            <Link to="/blog">
              <FaBlogger color="#fc4f08" size={35} className="cursor-pointer" />
            </Link>
          </Tooltip>
